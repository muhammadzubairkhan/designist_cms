...
<html class="no-js" lang="en">
    ...
    <body>
		...
		Add Page
                        ...
                        <p class="title-description"> Enter the new details for the page </p>
                    </div>
                                                    ...
                                                    <form action="">
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="email">Page Name:</label>
                                                                <input type="text" name="page_name" class="form-control" id="email">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="email">Page Title:</label>
                                                                <input type="text" name="page_title" class="form-control" id="email">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="email">Page Content:</label>
                                                                <input type="text" name="page_content" class="form-control" id="email">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            ...
                                                            <input type="text" name="page_slug" class="form-control" id="pwd">
                                                          </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="pwd">Page Menu:</label>
                                                            <input type="text" name="page_menu" class="form-control" id="pwd">
                                                          </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="pwd">Page Parent:</label>
                                                            <input type="text" name="page_parent" class="form-control" id="pwd">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            ...
                                                            <input type="text" name="page_excerpt" class="form-control" id="pwd">
                                                          </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="pwd">Page Type:</label>
                                                            <input type="text" name="page_type" class="form-control" id="pwd">
                                                          </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="pwd">Page author:</label>
                                                            <input type="text" name="page_author" class="form-control" id="pwd">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-12">
                                                          <div class="form-group">
                                                            ...
                                                            <input type="text" name="page_url" class="form-control" id="pwd">
                                                          </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <button type="submit" name="btnAddPage" class="btn btn-default btn-success">Add Page</button>
                                                      </div>
                                                    </form>
                                                </div>
                                            </div>
